...
<html lang="en">
  <head>
    ...
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_lioshi.min.css">-->
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_googlecode.min.css">  -->
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_default-dark.min.css">-->
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_tomorrow-night-blue.min.css">-->
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_magula.min.css">-->
    <!--<link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/hljs_docco.min.css">-->
